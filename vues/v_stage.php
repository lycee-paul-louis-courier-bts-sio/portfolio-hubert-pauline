<div class="container">
  <div class="text-primary-emphasis">
    <h1>Présentation de l'entreprise STOCK2COM</h1>
      <div class="card" >
        <div class="card-body">
        ...
        <div class="card text-center">
          <div class="card h-100">
            <div class="card-body">
              ...
              <p class="card-text">Développement Ruby On Rails</p>
              <a href="index.php?uc=stage2025" class="btn btn-primary">Détail du stage</a>
            </div>
          </div>
          </div> 
        </div>  
          ...
          <div class="card h-100">
            <div class="card-body">
              <h5 class="card-title">2026</h5>
                <p class="card-text">Data Analyse</p>
                <a href="index.php?uc=stage2026" class="btn btn-primary">Détail du stage</a>
            </div>
          </div>
          </div>
        </div>
